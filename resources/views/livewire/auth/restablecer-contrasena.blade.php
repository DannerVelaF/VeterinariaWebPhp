                ...
                <form wire:submit.prevent="validateEmail"
                    ...
                    <div class="text-center space-y-4">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-gray-500 mt-1">Ingresa tu correo para continuar</p>
                        </div>
                    </div>
                    ...
                    <div class="text-center pt-4 border-t border-gray-200">
                        <p class="text-xs text-gray-500">
                            ...
                            <a class="text-purple-600 hover:text-purple-700 font-medium transition-all ease-in-out"
                               href="{{ route('login') }}">
                ...
                <form wire:submit.prevent="resetPassword"
                    ...
                    <div class="text-center space-y-4">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-600 mt-2">ADELA Veterinaria & Spa</p>
                            <p class="text-xs text-gray-500 mt-1">Crea tu nueva contraseña</p>
                        </div>
                    </div>
                    ...
                    <div class="bg-blue-50 border border-blue-200 rounded-lg p-3 text-center">
                        <p class="text-sm text-blue-700">
                            <strong>Usuario:</strong> {{ $user->persona->correo_electronico_personal }}
                        </p>
                    </div>
                    ...
                    @if ($alertMessage)
                        <div
                            ...
                            init() {
                                @if($alertType === 'success')
                                    // Redirigir después de 3 segundos si es éxito
                                    setTimeout(() => {
                    ...
                    <div class="flex space-x-3">
                        ...
                        <button type="button" wire:click="goBack"
                                class="flex-1 bg-gray-500 text-white font-semibold py-3 rounded-lg hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 transform hover:scale-[1.02] transition-all duration-200 shadow-lg">
                        <span class="flex items-center justify-center space-x-2">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
