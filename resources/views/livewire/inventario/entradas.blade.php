        ...
        <div class="grid grid-cols-[2fr_3fr] gap-5 max-w-full">
                ...
                <form wire:submit.prevent="registrar" class="grid grid-cols-1 gap-4 text-sm mt-5">
                    ...
                    <div class="flex gap-5 ">
                        ...
                        <div class="flex flex-col gap-2 w-full">
                            ...
                            <input type="text" id="proveedor" class="border rounded px-2 py-1 border-gray-200 w-full"
            ...
            <x-card class="h-auto">
                <div class="flex flex-col gap-2">
                    ...
                    <p class="text-md">Últimas 10 entradas registradas.</p>
                </div>
                <div class="flex items-start justify-center h-full mt-5">
                    @if ($top10entradas->count() > 0)
                        <div class="w-full flex flex-col gap-2 overflow-y-auto max-h-[520px]">
                            @foreach ($top10entradas as $entrada)
                                <div class="flex flex-col gap-1 border border-gray-200 rounded-lg p-4 w-full">
                                    <p class="font-medium text-xl">{{ $entrada->lote->producto->nombre_producto }}
                                        <span
                                            class="bg-[#374151] text-white px-3 rounded-md text-sm">+{{ $entrada->cantidad_movimiento }}</span>
                                    </p>
                                    <p>
                                        {{ $entrada->lote->observacion }}
                                    </p>
                                    <p class="capitalize flex items-center gap-2 text-sm">
                    ...
                    @else
                        <div class="text-center flex items-center justify-center flex-col">
                            ...
                            <p class="text-2xl mt-5 font-normal text-gray-500">No hay entradas registradas.</p>
                            <p class="font-normal text-lg text-gray-500">Las entradas aparecerán aqui una vez registre
                                la primera.</p>
                        </div>
                    @endif
                </div>
            ...
            @if ($showModal && $selectedEntrada)
                <div class="fixed inset-0 flex items-center justify-center bg-black/50 z-50">
                    <div class="bg-white rounded-xl shadow-xl w-1/2 p-6">
                        ...
                        <p><strong>Producto:</strong> {{ $selectedEntrada->lote->producto->nombre_producto }}</p>
                        <p><strong>Cantidad:</strong> {{ $selectedEntrada->cantidad_movimiento }}</p>
                        <p><strong>Ubicación:</strong> {{ $selectedEntrada->ubicacion }}</p>
                        <p><strong>Usuario:</strong> {{ $selectedEntrada->trabajador->persona->user->username }}</p>
