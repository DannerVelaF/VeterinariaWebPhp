<x-panel title="Gestión de Categorías de Servicios" class="max-w-7xl mx-auto">
    <x-tabs :tabs="['listado' => '📋 Detalle categorías registradas', 'registro' => '➕ Registrar nueva categoría']" default="listado">
        <!-- TAB 1: LISTADO -->
        <x-tab name="listado">
            <div class="p-4">
            ...
            <div class="p-3 bg-gray-50 rounded">
                <form wire:submit.prevent="guardar" class="grid grid-cols-2 gap-4 text-xs">
                    ...
                    <div class="col-span-2">
                        <p class="font-bold text-gray-700 mb-3">🧾 Información de la categoría de servicio</p>
                    </div>

                    <div class="flex flex-col">
                        <label for="nombre_categoria_servicio" class="font-bold mb-1">Nombre de la categoría <span
                        ...
                        <input type="text" id="nombre_categoria_servicio" name="nombre_categoria_servicio" maxlength="255"
                            ...
                            placeholder="Ej. Servicios de baño, peluquería, consultas, etc."
                    ...
                    <div class="flex flex-col col-span-2">
                        <label for="descripcion" class="font-bold mb-1">Descripción de la categoría <span
                                class="text-red-500">*</span></label>
