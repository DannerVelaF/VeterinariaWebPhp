<x-panel title="Gestión de clientes" :breadcrumbs="[
    ...
    <x-tabs :tabs="['listado' => '📋 Detalle clientes registrados', 'registro' => '➕ Registrar nuevo cliente']"
            default="listado">
        <!-- TAB 1: LISTADO -->
        <x-tab name="listado">
            <div class="p-4">
        ...
        <x-tab name="registro">
            ...
            @if (session()->has('success'))
                <div class="mb-4 p-3 bg-green-100 border border-green-400 text-green-700 rounded" d
                     x-data="{ show: true }"
